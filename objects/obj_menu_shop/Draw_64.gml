...
if global.build_target != BUILD_TARGET.HTML{
	...
	draw_text_outline(_x_start, _y_start + 50, discount_text,2,c_black,4);
	draw_set_color(cost_color);
	...
	draw_text_outline(_x_start, _y_start + 50, discount_text,2,c_black,4);
	draw_set_color(cost_color);
	draw_text(flower_text_x, flower_text_y, "Flower Seeds: ");
	draw_text(flower_text_x, flower_amount_text_y,  num_flower_seeds);
	draw_text(flower_text_x, flower_cost_text_y, "Cost: " + string(num_flower_seeds * flower_price));

	draw_text(bush_text_x, bush_text_y, "Bush Seeds: ");
	draw_text(bush_text_x, bush_amount_text_y,  num_bush_seeds);
	draw_text(bush_text_x, bush_cost_text_y, "Cost: " + string(num_bush_seeds * bush_price));

	draw_text(tree_text_x, tree_text_y, "Tree Saplings: ");
	draw_text(tree_text_x, tree_amount_text_y,  num_tree_saplings);
	draw_text(tree_text_x, tree_cost_text_y, "Cost: " + string(num_tree_saplings * tree_price));
